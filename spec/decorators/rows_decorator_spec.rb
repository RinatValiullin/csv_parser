...
describe RowsDecorator do
  it "#decorate" do
    ...
    expect(RowsDecorator.new(file_data.values_by_columns).decorate(file_data.types)).to eql expected_data
  end
end
